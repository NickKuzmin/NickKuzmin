...
🏢 **Currently**: Building Russia's leading industrial digitalization platform [*Bimeister Flow\Data\Construct\Right\Control*]
...
🛠 **Tech Stack:** C# .Net, EF Core, PostgreSQL, Redis, RabbitMQ, MassTransit, K8s/Docker, Gitlab, Grafana/EFK, Amazon S3, xUnit.NET, FluentValudation, MediatR, Angular. 
